...
export const dashboard = 'https://dashboard.wildhacks.net/';

export const instagram = 'https://www.instagram.com/wildhacks/';
export const facebook = 'https://www.facebook.com/WildHacksNU';
...
export const tracks = [
  "Enigmatic Expedition to the Bibliophile's Sanctuary",
  "Alchemist's Challenge: Elixir of Empowerment",
  'The Quest for the Elusive Tome',
];
...
//       <span>workshops</span>,<span>free food from Evanston restaurants</span>,
//       <span>fun social and de-stress events</span>, <span>free swag</span>, and
//       more!
//     </>
//   ),
...
//     </>
//   ),
//   'Where can I find an event-based schedule for the entirety of this hackathon?':
//     (
//       <>
//         The full schedule will be released closer to the event, but check-in
//         will begin at <span>9:00 AM on Saturday, April 15, 2023</span> with the
//         opening ceremony starting at <span>11:00 AM</span>, and the closing
//         ceremony will end at <span>5:00 PM on Sunday, April 16, 2023</span>.
//       </>
//     ),
//   'What will I submit?': (
//     <>
...
//   'How will teams work?': (
//     <>
//       Teams can consist of up to <span>4 members</span>! We strongly encourage
...
//     </>
//   ),
//   'Will there be sleeping / showering accommodations?': (
//     <>
...
//     </>
//   ),
//   'Will transportation be reimbursed?': (
//     <>Transportation will not be reimbursed.</>
//   ),
//   'Do we have to stay for the full 36 hours?': (
//     <>
//       No, you are free to leave the event before the hackathon ends! However, in
//       order to claim prizes, you must be present at the closing ceremony on
//       Sunday, April 15 at 4:00 PM.
//     </>
//   ),
//   'What are the tentative COVID protocols?': (
//     <>
//       No, you are free to leave the event before the hackathon ends! However, in
//       order to claim prizes, you must be present at the closing ceremony on
//       Sunday, April 15 at 4:00 PM.
